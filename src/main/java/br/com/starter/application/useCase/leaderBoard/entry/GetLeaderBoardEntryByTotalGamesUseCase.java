...
public class GetLeaderBoardEntryByTotalGamesUseCase {

    private final LeaderboardEntryService leaderboardEntryService;
    public List<LeaderboardEntry> execute(Integer minGames) {
        return leaderboardEntryService.findByTotalGamesGreaterThanEqual(minGames);
    }
}
